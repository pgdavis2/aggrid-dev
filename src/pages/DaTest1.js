...
import AggridChart3 from '../components/charts/AggridChart3';
...
//This is where the fun begins
  ...
  <Box >
      ...
      <Grid  item sm="auto"><Kpi1 /></Grid>

      <Grid id='barChart' item sm={3}></Grid>

      <Grid item sm="auto">
        <Item><AggridChart3 /></Item>
      </Grid>
      ...
      <Grid className='ag-theme-balham' item sm={12} sx={{ height: '600px' }}>
      <button 
